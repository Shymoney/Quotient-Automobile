      ...
      <div class="col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6">
        <div class="login-wrap signupform text-center" style="margin-top:2em;">
          ...
          <div class="panel panel-default">
            ...
            <a href="#"><img src="images/logo-white-2.png" class="img-responsive img-rounded">
              </a>
                </div>
            ...
            <div class="panel-body" style="padding-bottom:1em;">
             <h4 class="text-muted">Signup for <strong class="text-red">FREE</strong>in just 5 seconds</h4>
              ...
              <div class="hr-text"><span>OR</span></div>
                ...
                <div class="form-group">
                  <input type="text" id="number" name="number" class="form-control" placeholder="Phone number (08XX XXX XXXX)" required="" />                
                  </div>
                ...
                <div class="row">
                  <div class="col-xs-6">
                    <div class="form-group">
                     <select id="gender" name="gender" class="form-control" placeholder="Gender" required="gender">
                ...
                <div class="form-group">
                  <input type="password" id="password" name="create_password" class="form-control" placeholder="Create Password"  required="" />              
                    </div>
                ...
                <br>
                <p class="text-muted small">By clicking "Get started now" I agree to Quotient's Automobile <a href="#">Terms of Service</a></p>
              </form>            
              </div>
          </div>
          <a href="#" class="ftlink">Already a member? <span>Login here</span></a>
        </div>
      </div>
    </div>
  </div>
